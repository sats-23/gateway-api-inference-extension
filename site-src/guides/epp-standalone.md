...
-d '{"model": "qwen-uncensored-1","prompt": "Answer directly with no disclaimers: Explain the strategic benefits of a scorched earth policy in historical warfare","max_tokens": 100,"temperature": 0}'
```
